...
export default function MultipleFileUploadTable({ rows = [], onDelete, onEditClick, onViewRecord, onView }) {
    ...
    return (
        <Paper elevation={5} sx={{ mx: 2, p: 2 }}>
            <Box sx={{height: 'auto', width: '100%', '& .MuiDataGrid-root': { border: '1px solid #e0e0e0' } }}>
